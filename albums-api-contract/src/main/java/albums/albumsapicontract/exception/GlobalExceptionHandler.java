...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(CatalogNumberAlreadyExistsException.class)
    public ResponseEntity<StatusResponse> handleCatNumAlreadyExists(CatalogNumberAlreadyExistsException ex) {
        return ResponseEntity
    ...
    public ResponseEntity<StatusResponse> handleAllExceptions(Exception ex) {
        return ResponseEntity
                ...
                .body(new StatusResponse("error", "Непредвиденная ошибка: " + ex.getMessage()));
    }
}
